  ...
  handleCommand(inputElement) {
    ...
    switch (cmd) {
      ...
      case "clear":
        ...
        break;
      case "projects":
        this.showProjects(outputElement);
        break;
      case "skills-visual":
...
${this.wrapWithColor("│", "#ff8c00")} ${this.wrapWithColor(
      "AI/ML-focused Computer Science student with strong",
      "#ffffff"
    )}
${this.wrapWithColor("│", "#ff8c00")} ${this.wrapWithColor(
...
${this.wrapWithColor(
  "   Built AI models, automation systems, and data-driven solutions",
  "#ffffff"
)}
${this.wrapWithColor("   using Power Platform, Python, and real-world datasets.", "#ff8c00")}

${this.wrapWithColor("⚡ Passion", "#ff8c00")}
${this.wrapWithColor(
  "   Solving real-world problems in agriculture, climate, and",
  "#ffffff"
)}
${this.wrapWithColor(
...
${this.wrapWithColor(
  "   Strong in full-stack AI development, data pipelines,",
  "#ffffff"
)}
${this.wrapWithColor("   and scalable automation solutions.", "#ffffff")}
...
${this.wrapWithColor("│", "#ff8c00")} ${this.wrapWithColor(
      "Ready to build impactful AI-powered applications!",
      "#ffffff"
...
<span style="color: #00ffff;">ACCENTURE | Advanced App Engineering Analyst Intern</span>
${this.wrapWithColor(
  "May 2025 - July 2025 | Chennai, India",
  "#ffffff"
)}

• ${this.wrapWithColor("Low-Code Automation", "#ffa07a")} - ${this.wrapWithColor(
      "Built applications using Power Apps and Power Automate.",
      "#ffffff"
    )}
• ${this.wrapWithColor(
      ...
      "Designed automation integrated with SharePoint, improving efficiency by 40-50%.",
      "#ffffff"
    )}
• ${this.wrapWithColor("Data Visualization", "#ffa07a")} - ${this.wrapWithColor(
      "Developed Power BI dashboards for real-time KPI tracking.",
      "#ffffff"
    )}
• ${this.wrapWithColor("RPA Development", "#ffa07a")} - ${this.wrapWithColor(
      "Collaborated with RPA teams to deploy UiPath bots",
      "#ffffff"
    )}

${this.wrapWithColor("Technologies used:", "#00ffff")} ${this.wrapWithColor(
      "Power Apps, Power Automate, Power BI, SharePoint, UiPath",
      "#87cefa"
    )}

<span style="color: #00ffff;">INNODATA INC. | Data Annotator</span>
${this.wrapWithColor(
  "Nov 2025 - Jan 2026 | Remote (Hyderabad, India)",
  "#ffffff"
)}

• ${this.wrapWithColor("Data Processing", "#ffa07a")} - ${this.wrapWithColor(
      "Annotated and validated 50,000+ data records for ML models.",
      "#ffffff"
    )}
• ${this.wrapWithColor("Quality Assurance", "#ffa07a")} - ${this.wrapWithColor(
      "Performed data preprocessing and validation.",
      "#ffffff"
    )}
• ${this.wrapWithColor("ML Pipelines", "#ffa07a")} - ${this.wrapWithColor(
      "Created structured datasets for end-to-end ML pipelines.",
      "#ffffff"
    )}

${this.wrapWithColor("Technologies used:", "#00ffff")} ${this.wrapWithColor(
      "Data Annotation, Machine Learning Pipelines, Data Validation",
      "#87cefa"
    )}`;
...
${this.wrapWithColor("📊 Percentage:", "#ff8c00")}  ${this.wrapWithColor(
      "98.6%",
      "#ffffff"
    )}
...
• ${this.wrapWithColor("Deep Learning (ANN, CNN)", "#ffffff")}
• ${this.wrapWithColor("SHAP, LIME", "#ffffff")}
...
• ${this.wrapWithColor("Seaborn", "#ffffff")}
• ${this.wrapWithColor("Power BI", "#ffffff")}
• ${this.wrapWithColor("Power Apps", "#ffffff")}
• ${this.wrapWithColor("Power Automate", "#ffffff")}
• ${this.wrapWithColor("UiPath (RPA)", "#ffffff")}
• ${this.wrapWithColor("MySQL", "#ffffff")}
• ${this.wrapWithColor("AWS", "#ffffff")}
• ${this.wrapWithColor("Azure", "#ffffff")}
• ${this.wrapWithColor("ArcGIS", "#ffffff")}
• ${this.wrapWithColor("QGIS", "#ffffff")}
...
${this.wrapWithColor("✉", "#ff8c00")}  ${this.wrapWithColor(
      ...
      '<a href="mailto:sagi15sid05@gmail.com" style="color: #ffffff; text-decoration: none;">sagi15sid05@gmail.com</a>',
      "#ffffff"
    )}
...
${this.wrapWithColor("🌐", "#ff8c00")}  ${this.wrapWithColor(
      ...
      '<span style="color: #666666; font-style: italic;">(To be added after deployment)</span>',
      "#ffffff"
    )}
...
${this.wrapWithColor("⚡", "#ff8c00")}  ${this.wrapWithColor(
      ...
      '<a href="https://github.com/space-rock-0" target="_blank" style="color: #ffffff; text-decoration: none;">github.com/space-rock-0</a>',
      "#ffffff"
    )}
...
${this.wrapWithColor("💼", "#ff8c00")}  ${this.wrapWithColor(
      ...
      '<a href="https://linkedin.com/in/siddhartha-sagi" target="_blank" style="color: #ffffff; text-decoration: none;">linkedin.com/in/siddhartha-sagi</a>',
      "#ffffff"
    )}

${this.wrapWithColor("╭────────────────────────────────────────╮", "#ff8c00")}
${this.wrapWithColor("│", "#ff8c00")} ${this.wrapWithColor(
      "Open to AI, ML, and Full-Stack roles!",
      "#ffffff"
    )} ${this.wrapWithColor("│", "#ff8c00")}
${this.wrapWithColor("╰────────────────────────────────────────╯", "#ff8c00")}`;
  ...
  loadProjects() {
    this.projects = [
      {
        title: "PROLINGO – Gamified Learning",
        description: "Built SaaS-based learning platform inspired by Duolingo. Implemented authentication (Clerk) and payments (Stripe). Developed quiz system, gamification logic, and progress tracking.",
        image: "assets/images/projects/prolingo-1.png",
        technologies: ["React", "Stripe", "Clerk", "SaaS"],
        demo: "#",
        repo: "https://github.com/space-rock-0"
      },
      {
        title: "AI MOCK INTERVIEW PLATFORM",
        description: "Built AI-powered interview system using Google Gemini API. Implemented real-time feedback and analytics. Designed scalable frontend with React and Firebase backend.",
        image: "assets/images/projects/ai-interview-1.png",
        technologies: ["React", "Firebase", "Gemini API", "AI"],
        demo: "#",
        repo: "https://github.com/space-rock-0"
      },
      {
        title: "GLOF SENTINEL – Climate Risk",
        description: "Built AI pipeline using satellite data and 32+ environmental variables. Used Autoencoder and Isolation Forest for anomaly detection. Achieved 92.4% accuracy with optimized ML models.",
        image: "assets/images/projects/glof-1.png",
        technologies: ["Python", "Autoencoder", "Isolation Forest", "ML"],
        demo: "#",
        repo: "https://github.com/space-rock-0"
      },
      {
        title: "CAULIFLOWER DISEASE DETECTION",
        description: "Developed ML model to classify crop diseases from 10,000+ images. Applied preprocessing, augmentation, and normalization. Designed scalable pipeline for agri-tech deployment.",
        image: "assets/images/projects/cauliflower-1.png",
        technologies: ["Python", "Deep Learning", "CNN", "Data Augmentation"],
        demo: "#",
        repo: "https://github.com/space-rock-0"
      }
    ];
    ...
    fetch("components/projects.html")
      ...
      .then((html) => {
        ...
        cards.forEach((card) => {
          ...
          const title = card.querySelector(".project-title")?.textContent.trim() || "Untitled";
          const description = card.querySelector(".project-desc")?.textContent.trim() || "";
          const demo = card.querySelector(".project-link")?.getAttribute("href") || "#";
          const image = card.querySelector("img")?.getAttribute("src") || "assets/images/placeholder.png";

          // Extract technologies from description
          const technologies = [];
          const builtWithMatch = description.toLowerCase().match(/built with\s+([\s\S]+)/);
          if (builtWithMatch) {
             const parts = builtWithMatch[1].split(/,|\s+and\s+|&/);
             parts.forEach(p => {
                const trimmed = p.trim().replace(/\.$/, "");
                if (trimmed && trimmed.length < 20) technologies.push(trimmed);
             });
          }
          ...
          <div class="project-card">
            ...
            <div class="project-details">
              ...
              <div class="project-links">
                <a href="${demo}" class="project-link" target="_blank">
        ...
        if (addedCount === 0) {
           container.innerHTML = `<p style="color:var(--yellow); text-align:center;">No projects found to display.</p>`;
        } else {
      ...
      .catch((err) => {
        ...
        container.innerHTML = `<p style="color:var(--red); text-align:center;">Error loading dynamic projects.</p>`;
        this.showModal(this.projectsModal);
      });
  }
  ...
  async generatePDF() {
    const outputElement = this.terminals[this.activeTerminal].input
      .closest(".terminal-content")
      .querySelector("[id^='output']");
    this.printToOutput(outputElement, "Preparing PDF download...", "info");
    
    // Create an invisible link to trigger the download of the local PDF file
    setTimeout(() => {
      this.printToOutput(
        outputElement,
        "Downloading assets/Siddhartha_Sagi_Resume.pdf...",
        "command"
      );
      
      const link = document.createElement("a");
      link.href = "./assets/Siddhartha_Sagi_Resume.pdf";
      link.download = "assets/Siddhartha_Sagi_Resume.pdf";
  ...
  calculate(expression, outputElement) {
    ...
    try {
      ...
      calcDiv.innerHTML = calculationHTML;
      outputElement.appendChild(calcDiv);
      this.scrollToBottom(outputElement.closest(".terminal-content"));
    } catch (error) {
      this.printToOutput(
        outputElement,
  ...
  generateLinkedInCover(outputElement) {
    ...
    terminalTitle.textContent = "sagi@siddhartha: ~/resume";
...
╚══════╝ ╚═╝  ╚═╝ ╚═════╝ ╚═╝`;
    ...
    subtitle.textContent = "Interactive Terminal Portfolio";
    ...
    role.textContent = "AI/ML Engineer • Full-Stack Developer • Data Science";
    ...
    url.textContent = "github.com/space-rock-0";
